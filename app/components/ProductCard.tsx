...
export default function ProductCard({ product }: { product: any }) {
  ...
  return (
    <View className="bg-white dark:bg-secondary w-[184px] rounded-[12px] border border-gray-100 dark:border-secondary shadow-sm mr-4 overflow-hidden mb-2">
      ...
      <View className="p-3.5 pt-3">
        ...
        {/* Category/Type */}
        <Text className="text-gray-500 dark:text-[#cfd9e7] text-xs font-semibold mt-0.5">
          {product.category}
        </Text>
